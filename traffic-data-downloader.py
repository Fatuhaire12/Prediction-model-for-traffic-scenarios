# -*- coding: utf-8 -*-
"""
Created on Tue Jul 10 12:00:05 2023
...
driver.get('http://tris.highwaysengland.co.uk/detail/trafficflowdata')


#grab the html
sel = Selector(text = driver.page_source)

# locate the Motorway button; in this case M6 Toll (because it had few zip files). Replace m6toll with m3 for M3 motorway
...
for i in range(len(data_names)):
    ...
    file_meta_data1 = pd.read_csv(file_name, error_bad_lines=False)
    file_meta_data1.columns = ['MIDAS ID','Legacy MIDAS ID','Site Name']
    file_meta_data = file_meta_data.append(file_meta_data1)
